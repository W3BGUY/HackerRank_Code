...
function Person(initialAge){
   // Add some more code to run some checks on initialAge
    ...
    this.amIOld=function(){ // Do some computations in here and print out the correct statement to the console 
      if(thisAge>=0 && thisAge<13){
        console.log("You are young.");
      }else if(thisAge>=13 && thisAge<18){
...
function main() {
  ...
  var T=parseInt(4);
  var input=[-1,10,16,18];
  for(i=0;i<T;i++){
    //var age=parseInt(readLine());
    var age=parseInt(input[i]);
